...
const JAPAN_ART: SampleEvent[] = [
  { year: -5000, title: '縄文土器の誕生', note: '世界最古級の土器。火炎土器など独創的な造形' },
  { year: -300,  title: '弥生土器・銅鐸', note: '大陸から稲作とともに伝わった文化。銅鐸は祭祀用' },
  { year: 250,   title: '埴輪（はにわ）の製作', note: '古墳に並べられた素朴な土の造形。日本最初の人物像' },
  { year: 593,   title: '仏教伝来と仏像制作', note: '聖徳太子の時代。止利仏師が法隆寺釈迦三尊像を制作' },
  { year: 710,   title: '天平文化の仏像彫刻', note: '東大寺・興福寺の仏像。大陸の影響を受けた豊かな表現' },
  { year: 806,   title: '密教美術の伝来', note: '空海が唐から曼荼羅・密教仏像を持ち帰る' },
  { year: 894,   title: '遣唐使廃止と国風文化', note: '大陸模倣から離れ、日本独自の美意識が芽生える' },
  { year: 1000,  title: '源氏物語絵巻', note: '平安時代。やまと絵の代表作。のちの日本絵画の原点' },
  { year: 1053,  title: '平等院鳳凰堂建立', note: '藤原頼通。極楽浄土を地上に再現した建築美術' },
  { year: 1185,  title: '武士文化の台頭と仏画', note: '鎌倉時代。力強くリアルな表現が生まれる' },
  { year: 1206,  title: '運慶「金剛力士像」', note: '東大寺南大門。圧倒的なリアリズムと躍動感' },
  ...
  { year: 1502,  title: '雪舟が水墨画を大成', note: '中国の水墨を日本化。「天橋立図」など風景画の傑作' },
  { year: 1543,  title: '南蛮文化の流入', note: 'キリシタン絵画・銅版画など西洋技法が伝来' },
  { year: 1590,  title: '長谷川等伯「松林図屏風」', note: '霧の中に浮かぶ松林。水墨画の最高傑作のひとつ' },
  { year: 1601,  title: '俵屋宗達が活躍', note: '装飾的・大胆な構図。琳派の源流' },
  { year: 1615,  title: '狩野派が幕府の御用絵師に', note: '金碧障壁画が権力の象徴として普及' },
  { year: 1680,  title: '元禄文化と浮世絵の誕生', note: '菱川師宣が版本浮世絵を確立。大衆文化の開花' },
  { year: 1716,  title: '尾形光琳「紅白梅図屏風」', note: '琳派の傑作。大胆な構図と圧倒的な装飾性' },
  { year: 1760,  title: '鈴木春信が多色刷り錦絵を完成', note: '浮世絵の黄金時代の始まり' },
  { year: 1794,  title: '東洲斎写楽が役者絵を描く', note: '10か月間だけ活動。個性的な誇張表現が謎多き天才' },
  { year: 1793,  title: '喜多川歌麿「婦女人相十品」', note: '美人画の最高峰。女性の内面も描く大首絵' },
  ...
  { year: 1876,  title: 'フォンタネージが洋画を指導', note: 'イタリア人教師が日本に写実的な洋画技法を伝える' },
  { year: 1889,  title: '黒田清輝が印象派を持ち帰る', note: '外光派の技法で日本洋画が変わる。「湖畔」など' },
  { year: 1907,  title: '文部省美術展覧会（文展）開設', note: '官展制度の確立。日本画・洋画・彫刻の三部門' },
  { year: 1910,  title: '横山大観「無我」', note: '朦朧体と呼ばれた輪郭線を消す革新的な日本画' },
  { year: 1922,  title: '竹久夢二の抒情画が流行', note: '大正ロマン。憂いある女性像が時代の気分を表す' },
  { year: 1945,  title: '戦後美術の再出発', note: '実験工房・アンデパンダン展。自由への希求' },
  { year: 1954,  title: '今井俊満らが抽象絵画を推進', note: 'アンフォルメル運動が日本に到来。具象から抽象へ' },
  { year: 1970,  title: '岡本太郎「太陽の塔」完成', note: '大阪万博のシンボル。縄文と前衛の衝突' },
  { year: 1989,  title: '奈良美智・草間彌生が国際デビュー', note: '日本の現代美術が世界舞台へ' },
  { year: 2000,  title: '村上隆「スーパーフラット」', note: '日本のポップカルチャーを現代美術に昇華。世界を席巻' },
]

const WORLD_ART: SampleEvent[] = [
  { year: -30000, title: 'ショーヴェ洞窟壁画', note: 'フランス。現存する最古の洞窟壁画。ライオンや犀を描く' },
  { year: -17000, title: 'ラスコー洞窟壁画', note: 'フランス。動物を描いた旧石器時代の傑作' },
  { year: -3200,  title: '古代メソポタミアの浮彫', note: 'シュメール。最古の文明の記念碑的芸術' },
  { year: -2500,  title: '古代エジプト美術', note: 'ギザのピラミッド・スフィンクス。正面性の法則' },
  { year: -1400,  title: 'ツタンカーメンの黄金マスク', note: 'エジプト新王国の精緻な工芸。1922年に発見' },
  { year: -900,   title: 'アッシリアの宮殿浮彫', note: 'ライオン狩りを描いた力強い浮彫。写実的表現の萌芽' },
  { year: -430,   title: 'ギリシャ彫刻の全盛期', note: 'フィディアス。パルテノン神殿の装飾。理想美の追求' },
  { year: -325,   title: 'ヘレニズム美術', note: 'アレクサンドロス大王後。感情を前面に出した表現主義的彫刻' },
  { year: -50,    title: 'ローマ美術', note: 'コロッセオ・トラヤヌス記念柱。ギリシャを継承し実用化' },
  { year: 532,    title: 'ハギア・ソフィア大聖堂', note: 'ビザンティン美術の頂点。黄金モザイクが輝く' },
  { year: 690,    title: 'ウマイヤ朝の岩のドーム', note: 'イスラム建築の最初期傑作。エルサレムに建設' },
  { year: 800,    title: 'カロリング朝美術', note: 'シャルルマーニュが芸術を奨励。写本装飾が発展' },
  { year: 1088,   title: 'ロマネスク建築の最盛期', note: '重厚な石造建築と半円アーチ。クリュニー修道院' },
  { year: 1163,   title: 'ノートルダム大聖堂着工', note: 'ゴシック建築。ステンドグラスが光を演出' },
  { year: 1305,   title: 'ジョットが西洋絵画を革新', note: 'スクロヴェーニ礼拝堂壁画。感情と空間を描いた先駆者' },
  { year: 1420,   title: 'ルネサンス（フィレンツェ）', note: 'ブルネレスキ・マサッチオが遠近法を確立' },
  { year: 1486,   title: 'ボッティチェッリ「ヴィーナスの誕生」', note: 'フィレンツェ。神話と美の融合。新プラトン主義の象徴' },
  { year: 1503,   title: 'モナ・リザ制作開始', note: 'ダ・ヴィンチ。スフマート技法。史上最有名の絵画' },
  { year: 1508,   title: 'システィナ礼拝堂天井画', note: 'ミケランジェロが4年かけて完成。神と人の対話' },
  { year: 1538,   title: 'ティツィアーノ「ウルビーノのヴィーナス」', note: 'ヴェネツィア派。豊かな色彩と官能美' },
  { year: 1600,   title: 'バロック美術の誕生', note: 'カラヴァッジオの劇的な光と影。激情の表現' },
  { year: 1637,   title: 'ベラスケス「ラス・メニーナス」', note: 'スペイン宮廷画家の傑作。視点の謎が今も議論される' },
  { year: 1642,   title: 'レンブラント「夜警」', note: 'オランダ黄金時代。光と影の革命的な集団肖像画' },
  { year: 1665,   title: 'フェルメール「真珠の耳飾りの少女」', note: '静謐な光の中の少女。オランダ黄金時代の象徴' },
  { year: 1748,   title: 'カナレット・ロココ美術', note: '軽やかで装飾的な様式。ヴェルサイユ宮殿の内装美術' },
  { year: 1784,   title: 'ダヴィッド「ホラティウスの誓い」', note: '新古典主義。ローマの英雄を描き革命精神を鼓舞' },
  { year: 1814,   title: 'ゴヤ「1808年5月3日」', note: '戦争の残酷さを描く。近代絵画の先駆け' },
  { year: 1818,   title: 'カスパー・D・フリードリヒ「霧の海の旅人」', note: 'ロマン主義。崇高な自然と孤独な人間' },
  { year: 1850,   title: 'クールベが写実主義を宣言', note: '「画家のアトリエ」。目に見えるものだけを描く' },
  ...
  { year: 1897,   title: 'ゴーガン「我々はどこから来たのか」', note: 'タヒチ。原始への憧憬と実存的問いを巨大画に' },
  { year: 1907,   title: 'ピカソ「アヴィニョンの娘たち」', note: 'キュビスムの誕生。美術史の最大の転換点のひとつ' },
  { year: 1913,   title: 'マレーヴィチ「黒の正方形」', note: '抽象芸術の極限。何も描かないことの意味' },
  { year: 1916,   title: 'ダダイズムの誕生', note: 'チューリッヒ。第一次大戦への反発から生まれた反芸術運動' },
  { year: 1931,   title: 'ダリ「記憶の固執」', note: 'シュルレアリスムの代表作。溶ける時計の衝撃' },
  { year: 1937,   title: 'ピカソ「ゲルニカ」', note: 'スペイン内戦の爆撃に憤り制作。反戦の象徴' },
  { year: 1947,   title: 'ポロック「フルフェイザム・ファイブ」', note: '抽象表現主義。床に広げたキャンバスに絵具を滴らせる' },
  { year: 1962,   title: 'ウォーホル「キャンベルのスープ缶」', note: 'ポップアートの象徴。商品が芸術になった瞬間' },
  { year: 1974,   title: 'コンセプチュアルアートの台頭', note: 'ヨーゼフ・ボイスら。作品より「概念」が芸術になる' },
  { year: 1990,   title: 'デミアン・ハーストが台頭', note: 'ヤング・ブリティッシュ・アーティスト。死と商業を直視' },
  { year: 2008,   title: 'ストリートアートの世界進出', note: 'バンクシーら。路上の落書きが美術館レベルへ' },
]
